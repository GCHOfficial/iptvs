...
| 2026-07-15 | PR 3 | In progress | Shared bounded HTTP/decompression boundary implemented and all Dart callers migrated; focused and full Flutter tests pass. Provider temp-file ingestion remains intentionally sequenced with PR 10's one-pass parser work. |
